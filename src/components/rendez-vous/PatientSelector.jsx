...
const PatientSelector = ({ quickBooking, setQuickBooking, patients, value, onChange }) => {
  return (
    <>
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <label className="flex items-start space-x-3">
          ...
          />
          <div>
            <span className="text-sm font-medium text-blue-800">Créer un nouveau patient</span>
            <p className="text-xs text-blue-700 mt-1">Cochez cette case pour enregistrer rapidement un patient avant de planifier son rendez-vous.</p>
          </div>
        </label>
      </div>
        ...
        <SearchableSelect
          ...
          renderOption={(option) => (
            <div className="flex flex-col">
              <span className="font-medium text-gray-900">{option.prenom} {option.nom}</span>
...
PatientSelector.propTypes = {
  quickBooking: PropTypes.object.isRequired,
  setQuickBooking: PropTypes.func.isRequired,
