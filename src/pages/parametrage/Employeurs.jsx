...
const Employeurs = () => {
  ...
  const [newItem, setNewItem] = useState({ 
    nom: undefined, adresse: undefined, telephone: undefined, email: undefined, actif: undefined
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNewItem({ nom: undefined, adresse: undefined, telephone: undefined, email: undefined, actif: undefined });
      setShowForm(false);
      fetchItems();
    } catch (error) {
