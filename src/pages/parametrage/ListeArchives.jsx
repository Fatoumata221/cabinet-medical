...
const ListeArchives = () => {
  ...
  const [newItem, setNewItem] = useState({ 
    nom: undefined, reference: undefined, famille: undefined, description: undefined, actif: undefined
  });
  ...
  const fetchItems = async () => {
    try {
      ...
      console.error('Erreur lors du chargement des liste des archives:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNewItem({ nom: undefined, reference: undefined, famille: undefined, description: undefined, actif: undefined });
      setShowForm(false);
      fetchItems();
    } catch (error) {
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredItems.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{item.famille}</td>
